...
class NotificationScreen extends ConsumerWidget {
  ...
  final DateTime timeBefore = DateTime.now().subtract(const Duration(days: 14));
  @override
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return FutureBuilder(
                        future: getUser(notificationSnapshot.data.docs[index]
                            ['notifierId']),
                        builder: (context,
                            ...
                            switch (notificationSnapshot.data.docs[index]
                              ...
                              case 'reply':
                                return FutureBuilder<user.User?>(
                                  future: getUser(notificationSnapshot
                                      ...
                                      return Column(
                                        children: [
                                          BoxForReplyNotification(
                                            ...
                                            originalCommentId:
                                                notificationSnapshot.data
                                                    .docs[index]['commentId'],

                                            articleOwnerId: notificationSnapshot
                                                .data
                                                .docs[index]['articleOwnerId'],
                                            notificationId: notificationSnapshot
                                                .data
