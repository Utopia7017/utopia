...
class ArticleBox extends ConsumerStatefulWidget {
  final Article? article;
  ArticleBox({required this.article});

  @override
  ConsumerState<ArticleBox> createState() => _ArticleBoxState();
}

class _ArticleBoxState extends ConsumerState<ArticleBox> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<User?>(
      future: getUser(widget.article!.authorId),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          return Builder(
            builder: (context) {
              if (dataController.myArticleState.fetchingSavedArticlesStatus ==
                  FetchingSavedArticles.NOT_FETCHED) {
                controller.fetchSavedArticles(dataController.userState.user!);
              }

              switch (
                  dataController.myArticleState.fetchingSavedArticlesStatus) {
                ...
                case FetchingSavedArticles.FETCHED:
                  int index = dataController.myArticleState.savedArticlesDetails
                      .indexWhere((element) =>
